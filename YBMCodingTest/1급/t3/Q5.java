...
public class Q5 {
    public String solution(String phrases, int second) {
        ...
        if(reminder == 14){
            ...
            for (int i = 0; i < 14-reminder; i++) {
                underBars+= "_";
            }
            answer = underBars + phrases.substring(0,reminder);
        }
        else if(reminder > 14){
            for (int i = 0; i < reminder-14; i++) {
                underBars+= "_";
            }
            answer = phrases.substring(reminder-14, phrases.length()) + underBars;
        }
